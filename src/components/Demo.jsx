    ...
    <section className='mt-16 w-full max-w-xl'>
      ...
      <div className='flex flex-col w-full gap-2'>
        ...
        >
          ...
          <input
            type='url'
            placeholder='Paste the link of any article on the web'
            value={article.url}
      ...
      <div className='my-10 max-w-full flex justify-center items-center'>
        ...
        We apologize for the inconvenience, but the Kamalogue blog summarizer app is currently experiencing an issue and is unable to summarize this blog. We suggest trying another blog. You can also try blogs from different blogging websites to get a more diverse range of perspectives. Thank you for using our app!
            <br />
